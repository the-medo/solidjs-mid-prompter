...
const Response: Component<Props> = (props) => {
  ...
  return (<div
    class="bg-white bg-opacity-60 p-4 rounded-md flex flex-row items-center"
    classList={{
      "bg-opacity-30": props.copied
    }}
  >
    <button onClick={onCopy} class="p-2 bg-dark-purple fill-white rounded-full hover:bg-opacity-80 mr-4"><BiRegularCopy /></button>
    {props.message}
  </div>)
}
