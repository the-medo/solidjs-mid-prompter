declare module '@external/mistralai' {
  ...
  class MistralClient {
    ...
    private _request(method: string, path: string, request: unknown): Promise<unknown>;
    ...
    embeddings(options: { model: string; input: string | string[] }): Promise<EmbeddingResponse>;
  }
